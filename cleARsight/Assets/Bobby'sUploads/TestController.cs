    ...
    public class TestController : MonoBehaviour
    {
        ...
        private void HandleOnTriggerDown(byte controllerId, float value)
        {
            ...
            if (controller != null && controller.Id == controllerId)
            {
                ...
                if (counter == 0)
                {
                    controller.StartFeedbackPatternVibe(MLInputControllerFeedbackPatternVibe.None, MLInputControllerFeedbackIntensity.Low);
                    counter++;
                }
                else if (counter == 1)
                {
                    controller.StartFeedbackPatternVibe(MLInputControllerFeedbackPatternVibe.ForceDwell, MLInputControllerFeedbackIntensity.Low);
                    counter++;
                }
                else if (counter == 2)
                {
                ...
                {
                    controller.StartFeedbackPatternVibe(MLInputControllerFeedbackPatternVibe.ForceDwell, MLInputControllerFeedbackIntensity.High);
                    counter = 0;
                }
            }
        }
