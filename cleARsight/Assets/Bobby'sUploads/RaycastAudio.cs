...
{
    /// <summary>
    /// Updates the transform and sound based on Raycast hit position
    /// </summary>
    public class RaycastAudio : MonoBehaviour
    {
        ...
        public void OnRaycastHit(MLWorldRays.MLWorldRaycastResultState state, RaycastHit result, float confidence)
        {
            ...
            {
                //result.distance is the hit distance
                ...
                //check if the raycast is in an unobserved part of room
            ...
            {
                // Case where the raycast went wrong
            }
        }
        #endregion
    }
