...
namespace MagicKit
{
    ...
    public class CursorController : Singleton<CursorController>
    {
        ...
        public event Action<GameObject> OnHighlightObject;
        public event Action<GameObject> OnUnhighlightObject;
        ...
        private void HandleRaycastHit(RaycastHit hit)
        {
            ...
            if (SelectedGameObject != hit.collider.gameObject && SelectedGameObject == null)
            {
                ...
                if (OnHighlightObject != null)
                {
                    OnHighlightObject(SelectedGameObject);
                }
            ...
            else if (SelectedGameObject != null)
            {
                ...
                if (OnUnhighlightObject != null)
                {
                    OnUnhighlightObject(SelectedGameObject);
                }
                SelectedGameObject = hit.collider.gameObject;
                if (OnHighlightObject != null)
                {
